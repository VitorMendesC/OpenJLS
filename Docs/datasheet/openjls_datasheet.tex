...
registers on the next clock (Figure~\ref{fig:timing-reset}).
...
register one clock after the reset is sampled.
...
\begin{tabular}{@{}r @{\hspace{1.2em}}|@{\hspace{1.2em}} r r r r@{}}
  ...
  \midrule
  4096  & 226.7 & 229.0          & 223.8          & \textbf{249.2} \\
  8192  & 241.0 & 247.8          & \textbf{248.1} & 205.9          \\
  12288 & 237.8 & \textbf{250.4} & 241.3          & 231.9          \\
  16384 & 201.5 & 241.8          & \textbf{252.0} & 247.5          \\
  32768 & 223.3 & 229.7          & \textbf{242.0} & 221.3          \\
...
so the winning strategy shifts with image size (results are deterministic, so the
per-size winner is a reliable selection). Table~\ref{tab:util} is for the default
