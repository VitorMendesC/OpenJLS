...
\begin{itemize}
  ...
  \item \textbf{Hardware-in-the-loop} --- the full 287-image corpus encoded end-to-end on a PYNQ-Z2 FPGA (depths 8--16) and byte-compared against CharLS on real silicon; zero mismatches. Produced by the \href{https://github.com/VitorMendesC/OpenJLS-Demos}{OpenJLS-Demos} EncodeOverEthernet project, a companion repository of end-to-end example designs that drive the core on hardware.
\end{itemize}
