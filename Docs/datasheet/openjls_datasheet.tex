...
\noindent For commercial licensing, technical questions, or collaboration
inquiries, contact
\textbf{\href{mailto:vitormendescamilo@protonmail.com}{vitormendescamilo\allowbreak @\allowbreak protonmail.com}}.
...
\noindent A full-resolution version of this diagram is available in the
repository: \url{https://github.com/VitorMendesC/OpenJLS}.
...
\begin{itemize}
  \item \textbf{OSVVM} --- per-module tests against independent T.87-derived
        ...
        backpressure, back-to-back images, dimension fallback) with requirements
        tracking.
