...
\medskip
\noindent For driver code the map ships as a copy/paste C header,
\texttt{Sources/Xilinx/ojls\_regs.h}, including the CAPS/MAXDIM
field-extraction macros and the core minima
(\texttt{OJLS\_MIN\_WIDTH}/\texttt{OJLS\_MIN\_HEIGHT}).
...
\begin{itemize}
  ...
  \item \textbf{Hardware-in-the-loop} --- The full 287-image corpus encoded end-to-end on a PYNQ-Z2 FPGA and byte-compared against CharLS on real silicon. Produced in the demos repository \href{https://github.com/VitorMendesC/OpenJLS-Demos}{OpenJLS-Demos} by the EncodeOverEthernet project.
\end{itemize}
