...
> **Status:** Active development. Core building blocks (codec segments, context memory) are implemented and individually verified. Top-level integration with AXI4-Stream interfaces is in progress.
