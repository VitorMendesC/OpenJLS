...
begin
  ...
  dut_n0 : entity work.a2_mode_selection(behavioral)
  ...
  dut_n2 : entity work.a2_mode_selection(behavioral)
  ...
  begin
    ...
    if (errCount > 0) then
      report "tb_A2 RESULT: FAIL (" & integer'image(errCount) & " errors)"
        severity failure;
    else
      report "tb_A2 RESULT: PASS"
        severity note;
    end if;
